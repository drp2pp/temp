...
public class UserServiceTest {
	...
	public void testAddUser() throws Exception {
		...
		User user = new User();
		user.setUserId("tesd");
		user.setUserName("tesrName");
		user.setPassword("tesswd");
		user.setSsn("111122222");
		user.setCellPhone("1112-3333");
		user.setAddr("경도");
		user.setEmail("testt.com");
		...
		Assert.assertEquals("111-2222-3333", user.getCellPhone());
...
//		user.setCellPhone("111-2222-3333");
//		user.setAddr("경기도");
//		user.setEmail("test@test.com");
	...
	//@Test
	 public void testUpdateUser() throws Exception{
		...
		user.setCellPhone("777-7777-7777");
		user.setAddr("change");
		...
		Assert.assertEquals("777-7777-7777", user.getCellPhone());
